    ...
    return (
        <header className="sticky top-0 z-50 w-full bg-pink-200">
            <div className="mx-auto flex h-16 max-w-7xl items-center justify-between gap-x-6 p-6">
                <button name="Settings" className="flex bg-pink-500 text-slate-50 p-2 rounded-full" onClick={toggleMenu}>
                ...
                >
                    <div className="p-4 flex flex-col h-full">
                        ...
                        <ul className="flex-grow">
                            ...
                            <li className="py-2">
                                <button className="text-gray-800 hover:text-gray-600" onClick={endSession}>
                                    <div className="flex flex-row gap-x-2">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-6">
...

                {
                    !focusModeEnabled &&
                    <div className="flex">
                        <div className="flex gap-x-6 bg-slate-50 p-2 rounded-full">
